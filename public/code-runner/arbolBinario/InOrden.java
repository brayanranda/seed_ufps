...
public class ArbolBinarioInOrden<T> {
    public static void main(String[] args) {
        ArbolBinarioInOrden<Integer> ArbolBinarioInOrden = new ArbolBinarioInOrden<>();
        NodoBin<Integer> nb=new NodoBin<>(2);
        ListaCD<Integer> list=new ListaCD<>();
        ArbolBinarioInOrden.setRaiz(nb);
        ArbolBinarioInOrden.inOrden(nb, list);
        System.out.println(ArbolBinarioInOrden);
    }
    private NodoBin<T> raiz;
    public ArbolBinarioInOrden(){this.raiz=null;}
    public ArbolBinarioInOrden(T raiz) {this.raiz = new NodoBin(raiz);}
